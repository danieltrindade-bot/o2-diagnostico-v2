...
export const SEED_COST_PARAMETERS: CostParameter[] = [
  ...
  { id: "cp-3", dimension: "financial", question_key: "q2", trigger_color: "red", label: "Inadimplência sem controle", pct_min: 0.03, pct_max: 0.05, qualitative: false },
  { id: "cp-4", dimension: "financial", question_key: "q2", trigger_color: "yellow", label: "Inadimplência parcialmente controlada", pct_min: 0.01, pct_max: 0.025, qualitative: false },
  ...
  { id: "cp-9", dimension: "commercial", question_key: "q2", trigger_color: "red", label: "Margem perdida em descontos sem critério", pct_min: 0.05, pct_max: 0.1, qualitative: false },
  { id: "cp-10", dimension: "commercial", question_key: "q2", trigger_color: "yellow", label: "Margem cedida sem necessidade", pct_min: 0.02, pct_max: 0.05, qualitative: false },
